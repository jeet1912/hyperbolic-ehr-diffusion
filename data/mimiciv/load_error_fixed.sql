-- Active: 1753949249665@@127.0.0.1@3306@mimic4
...
CREATE TABLE admissions (	-- rows=546028
   subject_id INT NOT NULL,	-- range: [10000032, 19999987]
   hadm_id INT NOT NULL,	-- range: [20000019, 29999935]
...
CREATE TABLE caregiver (	-- rows=17984
...
CREATE TABLE d_labitems (	-- rows=1650
...
CREATE TABLE diagnoses_icd (	-- rows=6364488
   subject_id INT NOT NULL,	-- range: [10000032, 19999987]
...
CREATE TABLE drgcodes (	-- rows=761856
   subject_id INT NOT NULL,	-- range: [10000032, 19999987]
...
CREATE TABLE icustays (	-- rows=94458
   subject_id INT NOT NULL,	-- range: [10000032, 19999987]
   hadm_id INT NOT NULL,	-- range: [20000094, 29999828]
   stay_id INT NOT NULL,	-- range: [30000153, 39999858]
...
CREATE TABLE labevents (	-- rows=158374764
...
CREATE TABLE microbiologyevents (	-- rows=3988224
...
CREATE TABLE patients (	-- rows=364627
   subject_id INT NOT NULL,	-- range: [10000032, 19999987]
...
CREATE TABLE poe (	-- rows=41427803
   poe_id VARCHAR(255) NOT NULL,	-- max length=14
   poe_seq BIGINT UNSIGNED NOT NULL,
   subject_id INT NOT NULL,	-- range: [10000032, 19999987]
   hadm_id INT NOT NULL,	-- range: [20000019, 29999928]
...
CREATE TABLE provider (	-- rows=42244
...
CREATE TABLE transfers (	-- rows=2413581
   subject_id INT NOT NULL,	-- range: [10000032, 19999987]
   hadm_id INT,	-- range: [20000019, 29999928]
